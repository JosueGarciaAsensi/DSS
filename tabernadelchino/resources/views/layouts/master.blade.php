            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                ...
                <form class="d-flex" action="{{ route('search') }}" method="GET">
                    ...
                    <div class="input-group mt-3">
                        <input type="text" id="search" name="search" class="form-control" placeholder="{{__('text.search')}}">
                ...
                <div class="navbar-nav">
                    ...
                    <form id="getCart-form" action="{{ route('cart-list', ['id' =>  Auth::user()->carts()->first()->id]) }}" method="GET" class="d-none">
                        @csrf
                    </form>
