<html>
    ...
    <body style="background-color: #ffa834;">
        @section('menu')
            <div class="d-flex justify-content-between px-4" style="background-color: black;">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('img/logo.png') }}" width=80>
                    <a href="{{ url('/admin') }}" class="navbar-brand" style="color:white">La Taberna del Chino Portal de Administración</a>
                </div>
                <div class="d-flex align-items-center">
                    <a href="#">
